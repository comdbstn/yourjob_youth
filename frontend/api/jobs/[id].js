...
export default async function handler(req, res) {
  ...
  try {
    ...
    const jobs = [
      {
        ...
        location: "서울",
        category: "IT·개발",
        description: "React와 TypeScript를 활용한 웹 서비스 개발을 담당할 프론트엔드 개발자를 채용합니다. 사용자 경험을 최우선으로 하는 서비스를 함께 만들어나갈 동료를 찾습니다.",
      ...
      },
      {
        ...
        location: "서울",
        category: "IT·개발",
        description: "Java와 Spring을 활용한 서버 개발을 담당할 백엔드 개발자를 채용합니다. 금융 서비스의 안정성과 확장성을 고려한 서버 아키텍처 설계에 참여하실 분을 찾습니다.",
      ...
      },
      {
        ...
        location: "서울",
        category: "디자인",
        description: "모바일 앱과 웹 서비스의 UX/UI 디자인을 담당할 디자이너를 채용합니다. 사용자 중심의 디자인으로 직관적이고 매력적인 인터페이스를 만들어주실 분을 찾습니다.",
      ...
      },
      {
        ...
        location: "경기", 
        category: "마케팅",
        description: "온라인 쇼핑몰의 디지털 마케팅을 총괄할 매니저를 채용합니다. 데이터 기반의 마케팅 전략 수립과 실행을 통해 비즈니스 성장을 이끌어주실 분을 찾습니다.",
      ...
      },
      {
        ...
        location: "서울",
        category: "인사·총무",
        description: "글로벌 컨설팅 회사에서 채용 및 인사관리를 담당할 HR 담당자를 채용합니다. 조직문화 개선과 인재 육성에 관심이 많으신 분들의 지원을 기다립니다.",
      ...
      },
      {
        ...
        location: "서울",
        category: "IT·개발",
        description: "머신러닝과 데이터 분석을 통해 비즈니스 인사이트를 도출할 데이터 사이언티스트를 채용합니다. 다양한 데이터를 활용한 예측 모델 개발 경험이 있으신 분을 찾습니다.",
      ...
      },
      {
        ...
        location: "대구",
        category: "영업",
        description: "B2B 영업을 담당할 매니저를 채용합니다. 기존 고객 관리와 신규 고객 발굴을 통해 매출 확대에 기여해주실 분을 찾습니다. 제조업 경험이 있으신 분을 우대합니다.",
      ...
      },
      {
        ...
        location: "서울",
        category: "IT·개발", 
        description: "Node.js 백엔드와 React 프론트엔드를 모두 다룰 수 있는 풀스택 개발자를 채용합니다. 빠르게 성장하는 스타트업에서 함께 성장할 개발자를 찾습니다.",
    ...
    console.error('개별 채용공고 API 오류:', error);
